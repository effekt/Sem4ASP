...
<head runat="server">
    <title>Handy Dandy Sports Center - Feedback</title>
            ...
            <asp:Panel class="collapse navbar-collapse" ID="sitenav" runat="server">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active">
                        <asp:HyperLink CssClass="nav-link" NavigateUrl="Feedback.aspx" runat="server">Feedback <span class="sr-only">(current)</span></asp:HyperLink>
                    </li>
                    <li class="nav-item">
