...
<head runat="server">
    <title>Handy Dandy Sports Center - Login</title>
            ...
            <asp:Panel class="collapse navbar-collapse" ID="sitenav" runat="server">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active">
                        <asp:HyperLink CssClass="nav-link" NavigateUrl="Login.aspx" runat="server">Login <span class="sr-only">(current)</span></asp:HyperLink>
                    </li>
                </ul>
            </asp:Panel>
        </div>
